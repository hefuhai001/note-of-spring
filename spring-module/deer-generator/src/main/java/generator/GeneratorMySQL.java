...
public class GeneratorMySQL {
     ...
     * 数据库连接url
     */
    public static final String URL = "jdbc:mysql://localhost/db_deer";
    /**
     * 数据库 用户名
     */
     ...
     * 作者
     */
    public static final String AUTHOR = "bestwishes0203";
    /**
     * java代码保存目录
     */
//    public static final String SAVE_PATH = System.getProperty("user.dir") + "/src/main/java";
     ...
     * 保存到包下面
     */
    public static final String PACKAGE = "com.example.deerweb";
    /**
     * 要生成的表
     */
