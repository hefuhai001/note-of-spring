...
# 提取所有class为view-num的span标签
view_num_tags = soup.find_all('span', class_='view-num')

# 提取所有class为give-like-num的span标签
give_like_num_tags = soup.find_all('span', class_='give-like-num')

# 提取所有class为comment-num的span标签
comment_num_tags = soup.find_all('span', class_='comment-num')

# 提取第奇数个<a>元素的href属性
href_odd = a_tags[0].get('href') if a_tags else None

# 提取<h4>标签中的文字
h4_text = h4_tags[0].get_text(strip=True) if h4_tags else None

# 提取class为view-num的元素内容
view_num_content = view_num_tags[0].get_text(strip=True) if view_num_tags else None

# 提取class为give-like-num的元素内容
give_like_num_content = give_like_num_tags[0].get_text(strip=True) if give_like_num_tags else None
...
print(f'奇数个<a>元素的href属性: {href_odd}')
print(f'<h4>标签中的文字: {h4_text}')
print(f'class为view-num的元素内容: {view_num_content}')
print(f'class为give-like-num的元素内容: {give_like_num_content}')
print(f'class为comment-num的第二个元素的内容: {comment_num_content}')