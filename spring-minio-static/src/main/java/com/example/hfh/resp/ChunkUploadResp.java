 ...
 * @version 1.0.0
 * @since 2025/8/1
 * @see com.example.hfh.controller.FileController#uploadChunk(String, int, int, org.springframework.web.multipart.MultipartFile, String, long) 返回此对象的接口
 * @see com.example.hfh.service.FileService#uploadChunk(String, int, int, org.springframework.web.multipart.MultipartFile, String, long) 构建此对象的业务逻辑
 * @see com.example.hfh.resp.FileUploadResp 普通上传的响应对象（对比参考）
 */
@Data
@AllArgsConstructor
