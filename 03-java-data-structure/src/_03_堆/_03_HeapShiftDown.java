 ...
 * 03往最大堆中取出一个元素
 */
public class _03_HeapShiftDown<T extends Comparable> {
    ...
    public _03_HeapShiftDown(int capacity){
    ...
    public static void main(String[] args) {
        _03_HeapShiftDown<Integer> heapShiftDown = new _03_HeapShiftDown<Integer>(100);
        // 堆中元素个数
        int N = 100;
        // 堆中元素取值范围[0, M)
        int M = 100;
